...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs='data:image/svg+xml;base64,'+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._image_1.onclick=function (e) {
			var flag=me._how.ggOpacitiyActive;
			if (player.transitionsDisabled) {
				me._how.style[domTransition]='none';
			} else {
				me._how.style[domTransition]='all 500ms ease-out 0ms';
			}
			if (flag) {
				me._how.style.opacity='0';
				me._how.style.visibility='hidden';
			} else {
				me._how.style.opacity='1';
				me._how.style.visibility=me._how.ggVisible?'inherit':'hidden';
			}
			me._how.ggOpacitiyActive=!flag;
		}
		me._image_1.ggUpdatePosition=function (useTransition) {
		}
		me._intro_ui_folder.appendChild(me._image_1);
		...
		me._image_2.onclick=function (e) {
			...
			if (
				...
				player.setVariableValue('mute', true);
			}
		}
		me._image_2.ggUpdatePosition=function (useTransition) {
		}
		me._intro_ui_folder.appendChild(me._image_2);
		el=me._image_3=document.createElement('div');
		els=me._image_3__img=document.createElement('img');
		els.className='ggskin ggskin_image_3';
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'vZ0u2qlwAAAABJRU5ErkJggg==';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
		...
		me._intro_ui_folder.appendChild(me._image_3);
		me.divSkin.appendChild(me._intro_ui_folder);
		el=me._flame_test=document.createElement('div');
		els=me._flame_test__img=document.createElement('img');
		els.className='ggskin ggskin_flame_test';
		hs=basePath + 'images/flame_test.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._flame_test.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._flame_test.logicBlock_size = function() {
			...
			if (me._flame_test.ggCurrentLogicStateSize != newLogicStateSize) {
				me._flame_test.ggCurrentLogicStateSize = newLogicStateSize;
				me._flame_test.style[domTransition]='width 0s, height 0s';
				if (me._flame_test.ggCurrentLogicStateSize == 0) {
					me._flame_test.style.width='100%';
					me._flame_test.style.height='40%';
					skin.updateSize(me._flame_test);
				}
				else {
					me._flame_test.style.width='80%';
					me._flame_test.style.height='80%';
					skin.updateSize(me._flame_test);
				}
			}
		}
		me._flame_test.onclick=function (e) {
			if (player.transitionsDisabled) {
				me._flame_test.style[domTransition]='none';
			} else {
				me._flame_test.style[domTransition]='all 500ms ease-out 0ms';
			}
			me._flame_test.style.opacity='0';
			me._flame_test.style.visibility='hidden';
		}
		me._flame_test.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me.divSkin.appendChild(me._flame_test);
		el=me._how=document.createElement('div');
		els=me._how__img=document.createElement('img');
		els.className='ggskin ggskin_how';
		hs=basePath + 'images/how.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._how.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._how.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width / player.getViewerSize().height < 1))
			)
			...
			if (me._how.ggCurrentLogicStateSize != newLogicStateSize) {
				me._how.ggCurrentLogicStateSize = newLogicStateSize;
				me._how.style[domTransition]='width 0s, height 0s';
				if (me._how.ggCurrentLogicStateSize == 0) {
					me._how.style.width='100%';
					me._how.style.height='40%';
					skin.updateSize(me._how);
				}
				else {
					me._how.style.width='80%';
					me._how.style.height='80%';
					skin.updateSize(me._how);
				}
			}
		}
		me._how.onclick=function (e) {
			if (player.transitionsDisabled) {
				me._how.style[domTransition]='none';
			} else {
				me._how.style[domTransition]='all 500ms ease-out 0ms';
		...
		me._how.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me.divSkin.appendChild(me._how);
	...
	me._flame_test.logicBlock_size();
	me._how.logicBlock_size();
	me._gyro_on.logicBlock_alpha();
	me._gyro_off.logicBlock_alpha();
	me._screentint_info.logicBlock_visible();
	me._information.logicBlock_visible();
	me._gyro.logicBlock_visible();
	player.addListener('sizechanged', function(args) { me._flame_test.logicBlock_size();me._how.logicBlock_size(); });
